...
const required = ['id="menu"', 'id="about"', 'id="atmosphere"', 'id="visit"', 'id="product-dialog"', 'id="cart-dialog"', 'data-product-id=', 'lang="ru"', '<title>milo — кофе и время для себя</title>'];
